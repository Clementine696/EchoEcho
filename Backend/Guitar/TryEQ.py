...
# VARS CONSTS: สร้างหน้าต่างตัวแอปมั้ง
_VARS = {'window': False,
         'stream': False,
         'audioData': np.array([])}

# pysimpleGUI INIT: ขนาดตัวหนังสือ, Backgrard กับขนาดของตัวแอป 
# ส่วน layout ก็เป็นส่วนตกแต่ง ตรงกลางแอป
AppFont = 'Any 16'
sg.theme('DarkBlue2')
CanvasSizeWH = 500
...
# INIT vars:
# ตั้งค่าว่าจะให้มันจับเสียงเท่าไร ตรงนี้น่าจะได้ใช้ในส่วนของ pyaudio ต่อ
...
def drawTicks():
    ...
    # สร้างกราฟ แล้วใส่สีให้ด้วย ทั้งแกน x และ y
