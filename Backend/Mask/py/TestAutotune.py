...
while len(audio_data) != 0:
    ...
    # # get the pitch of the input audio TODO: FIXME:
    ...
    # chroma = librosa.feature.chroma_stft(pitch)
    # pitch_shift_amount = librosa.midi_to_hz(librosa.midi_to_note(chroma)) - pitch
